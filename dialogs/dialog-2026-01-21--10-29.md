...
Changes:
  build-ai-hallucination-reducer-ui     No tasks      9m ago
➜  try-openspec git:(main) openspec validate build-ai-hallucination-reducer-ui
Change 'build-ai-hallucination-reducer-ui' is valid
➜  try-openspec git:(main) openspec show build-ai-hallucination-reducer-ui
